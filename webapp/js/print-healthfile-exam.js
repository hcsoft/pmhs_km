...
//儿童及孕产妇套打
PrintHealthFileAndExamClass.prototype.PrintVolumeBook = function(id,optype){
	console.log(id);
	console.log(optype);
	printerService.printerVolumeBook({printWhere:id,printType:optype},function(data){
		if(data != null && data.length > 0 ){
			if(optype == '1'){
				var printHtml = '<style type="text/css">.listInputValues {	margin-left: 10px;}.inputValues {	border: 1px solid #000;	width: 16px;	height: 16px;	text-align: center;}.printHealthFile,.table_personalInfor {	font-size: 14px;}.td_printHealthFile_content {	border-left: 1px solid #000000;	border-right: 1px solid #000000;	padding-left: 160px;	height: 60px;}.healthfileBasicInfo td {	height: 60px;	vertical-align: bottom;}.rightTableTd {	border-bottom: 1px solid #000000;}.table_personalInfor tbody td {	border-left: 1px solid #000;	border-right: 1px solid #000;	border-top: 1px solid #000;	height: 30px;	padding-left: 5px;}.childTable thead td {	border: none;}.childTable tbody td {	border: none;}.otherOption {	border-left: none;	border-right: none;	border-top: none;	border-bottom: 1px solid #000;	width: 80px;}.noneBorder {	text-align: center;	border: none;	width: 50px;}</style><div class="printHealthFile">	<table class="table_personalInfor" cellpadding="0" cellspacing="0"		style="width: 19cm; border-collapse: collapse;">		<thead>			<tr>				<td style="text-align: center; height: 30px;" colspan="6"><span					style="font-size: 20px; font-weight: bolder;">1岁以内儿童健康检查记录表</span></td>			</tr>			<tr>				<td colspan="2" style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">姓名：</span></td>				<td>{Name}</td>				<td style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">编号：</span></td>				<td colspan="2">{FileNo}</td>			</tr>		</thead>		<tbody>			<tr>				<td colspan="2" class="header">月龄</td>				<td>满月</td>				<td>3月龄</td>				<td>6月龄</td>				<td>8月龄</td>			</tr>			<tr>				<td colspan="2" class="header">随访日期</td>				<td>{VisitDate1}</td>				<td>{VisitDate2}</td>				<td>{VisitDate3}</td>				<td>{VisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header">体重(kg)</td>				<td>{Weight1},{WeightScore1}</td>				<td>{Weight2},{WeightScore2}</td>				<td>{Weight3},{WeightScore3}</td>				<td>{Weight4},{WeightScore4}</td>			</tr>			<tr>				<td colspan="2" class="header">身长(cm)</td>				<td>{Height1},{HeightScore1}</td>				<td>{Height2},{HeightScore2}</td>				<td>{Height3},{HeightScore3}</td>				<td>{Height4},{HeightScore4}</td>			</tr>			<tr>				<td colspan="2" class="header">头围(cm)</td>				<td>{Head1}</td>				<td>{Head2}</td>				<td>{Head3}</td>				<td>{Head4}</td>			</tr>			<tr>			<tr>				<td rowspan="16">体格检查</td>				<td class="header">面色</td>				<td>{Face1},{FaceOther1}</td>				<td>{Face2},{FaceOther2}</td>				<td>{Face3},{FaceOther3}</td>				<td>{Face4},{FaceOther4}</td>			</tr>			<tr>				<td class="header">皮肤</td>				<td>{Exam011},{Exam01Other1}</td>				<td>{Exam012},{Exam01Other2}</td>				<td>{Exam013},{Exam01Other3}</td>				<td>{Exam014},{Exam01Other4}</td>			</tr>			<tr>				<td class="header">前卤</td>				<td>{Exam021},{Exam031}cm x {Exam041}cm</td>				<td>{Exam022},{Exam032}cm x {Exam042}cm</td>				<td>{Exam023},{Exam033}cm x {Exam043}cm</td>				<td>{Exam024},{Exam034}cm x {Exam044}cm</td>			</tr>			<tr>				<td class="header">颈部包块</td>				<td>{Exam131}</td>				<td>{Exam132}</td>				<td>{Exam133}</td>				<td>—————</td>			</tr>			<tr>				<td class="header">眼外观</td>				<td>{Eyes1},{EyesOther1}</td>				<td>{Eyes2},{EyesOther2}</td>				<td>{Eyes3},{EyesOther3}</td>				<td>{Eyes4},{EyesOther4}</td>			</tr>			<tr>				<td class="header">耳外观</td>				<td>{Ears1},{EarsOther1}</td>				<td>{Ears2},{EarsOther2}</td>				<td>{Ears3},{EarsOther3}</td>				<td>{Ears4},{EarsOther4}</td>			</tr>			<tr>				<td class="header">听力</td>				<td>—————</td>				<td>—————</td>				<td>{Exam141}</td>				<td>—————</td>			</tr>			<tr>				<td class="header">口腔</td>				<td>{Exam151},{Exam15Other1}</td>				<td>{Exam152},{Exam15Other2}</td>				<td>{Exam153},{Exam15Other3}</td>				<td>{Exam154},{Exam15Other4}</td>			</tr>			<tr>				<td class="header">心肺</td>				<td>{Heart1},{HeartOther1}</td>				<td>{Heart2},{HeartOther2}</td>				<td>{Heart3},{HeartOther3}</td>				<td>{Heart4},{HeartOther4}</td>			</tr>			<tr>				<td class="header">腹部</td>				<td>{Exam061},{Exam06Other1}</td>				<td>{Exam062},{Exam06Other2}</td>				<td>{Exam063},{Exam06Other3}</td>				<td>{Exam064},{Exam06Other4}</td>			</tr>			<tr>				<td class="header">脐部</td>				<td>{Exam071},{Exam07Other1}</td>				<td>{Exam072},{Exam07Other2}</td>				<td>—————</td>				<td>—————</td>			</tr>			<tr>				<td class="header">四肢</td>				<td>{Exam161},{Exam16Other1}</td>				<td>{Exam162},{Exam16Other2}</td>				<td>{Exam163},{Exam16Other3}</td>				<td>{Exam164},{Exam16Other4}</td>			</tr>			<tr>				<td class="header">可疑佝偻病症状</td>				<td>{ChildrenMediExamExam091}</td>				<td>{ChildrenMediExamExam092}</td>				<td>{ChildrenMediExamExam093}</td>				<td>{ChildrenMediExamExam094}</td>							</tr>			<tr>				<td class="header">可疑佝偻病体征</td>				<td>{ChildrenMediExamExam101}</td>				<td>{ChildrenMediExamExam102}</td>				<td>{ChildrenMediExamExam103}</td>				<td>{ChildrenMediExamExam104}</td>				</tr>			<tr>				<td class="header">肛门 / 外生殖器</td>				<td>{Exam111},{Exam11Other1}</td>				<td>{Exam112},{Exam11Other2}</td>				<td>{Exam113},{Exam11Other3}</td>				<td>{Exam114},{Exam11Other4}</td>			</tr>			<tr>				<td class="header">血红蛋白值(g/L)</td>				<td>{Exam121}g/L</td>				<td>{Exam122}g/L</td>				<td>{Exam123}g/L</td>				<td>{Exam124}g/L</td>				</tr>			<tr>				<td colspan="2" class="header">户外活动</td>				<td>{ActivityTime1}小时/日</td>				<td>{ActivityTime2}小时/日</td>				<td>{ActivityTime3}小时/日</td>				<td>{ActivityTime4}小时/日</td>				</tr>			<tr>				<td colspan="2" class="header">服用维生素D</td>				<td>{WDCount1}IU/日</td>				<td>{WDCount2}IU/日</td>				<td>{WDCount3}IU/日</td>				<td>{WDCount4}IU/日</td>			</tr>			<tr>				<td colspan="2" class="header">发育评估</td>				<td>{Evaluate1},{EvaluateOther1}</td>				<td>{Evaluate2},{EvaluateOther2}</td>				<td>{Evaluate3},{EvaluateOther3}</td>				<td>{Evaluate4},{EvaluateOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">两次访问间患病情况</td>				<td>{State1}</td>				<td>{State2}</td>				<td>{State3}</td>				<td>{State4}</td>			</tr>			<tr>				<td colspan="2" class="header">其它</td>				<td>{Other1}</td>				<td>{Other2}</td>				<td>{Other3}</td>				<td>{Other4}</td>			</tr>			<tr>				<td colspan="2" class="header">转诊建议</td>				<td>{Transfer1}<br/>原因：{TransReason1}<br/>机构及科室：{TransUnit1}</td>				<td>{Transfer2}<br/>原因：{TransReason2}<br/>机构及科室：{TransUnit2}</td>				<td>{Transfer3}<br/>原因：{TransReason3}<br/>机构及科室：{TransUnit3}</td>				<td>{Transfer4}<br/>原因：{TransReason4}<br/>机构及科室：{TransUnit4}</td>			</tr>			<tr>				<td colspan="2" class="header">指导</td>				<td>{CheckDirect1},{CheckDirectOther1}</td>				<td>{CheckDirect2},{CheckDirectOther2}</td>				<td>{CheckDirect3},{CheckDirectOther3}</td>				<td>{CheckDirect4},{CheckDirectOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">下次随访日期</td>				<td>{NextVisitDate1}</td>				<td>{NextVisitDate2}</td>				<td>{NextVisitDate3}</td>				<td>{NextVisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header" style="border-bottom: 1px solid #000;">随访医生签名</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor1}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor2}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor3}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor4}</td>			</tr>		</tbody>	</table></div>';
				var keys = {};
				$.each(data,function(i,v){
					var VulumeType = v.VulumeType;
					$.each(v,function(key,val){
						if(!keys.hasOwnProperty(key)){
							keys[key] = key;
						}
						if(key != 'VulumeType'){
							if(key == 'FileNo' || key == 'Name'){
								printHtml = printHtml.replace(new RegExp("\\{"+key+"\\}","g"), val); 
							}else{
								var keyName = key + VulumeType;							
								if(key == 'VisitDate' && val != null){
									val = val.getFullYear() + '年' + PrintHealthFileAndExamClass.addZero(val.getMonth()) + '月' + 
										PrintHealthFileAndExamClass.addZero(val.getDate()) + '日';
								}
								if(key == 'Transfer'){
									if(val == 0) {
										val = '无';
								...
								if(val == null) val = '';
								printHtml = printHtml.replace(new RegExp("\\{"+keyName+"\\}","g"), val); 
							}
						}
					});
				});
				$.each(keys,function(i,v){
					for(var j = 1;j <= 4;j++){
						var keyName = v + j;
						printHtml = printHtml.replace(new RegExp("\\{"+keyName+"\\}","g"), ''); 
					}
				});
				console.log(printHtml);
				printObj.printHTML(printHtml,'1岁以内儿童健康检查记录表','12.99cm','30.8cm');
			}else if(optype == '2'){
				var printHtml = '\<style type="text/css">.listInputValues {	margin-left: 10px;}.inputValues {	border: 1px solid #000;	width: 16px;	height: 16px;	text-align: center;}.printHealthFile,.table_personalInfor {	font-size: 14px;}.td_printHealthFile_content {	border-left: 1px solid #000000;	border-right: 1px solid #000000;	padding-left: 160px;	height: 60px;}.healthfileBasicInfo td {	height: 60px;	vertical-align: bottom;}.rightTableTd {	border-bottom: 1px solid #000000;}.table_personalInfor tbody td {	border-left: 1px solid #000;	border-right: 1px solid #000;	border-top: 1px solid #000;	height: 30px;	padding-left: 5px;}.childTable thead td {	border: none;}.childTable tbody td {	border: none;}.otherOption {	border-left: none;	border-right: none;	border-top: none;	border-bottom: 1px solid #000;	width: 80px;}.noneBorder {	text-align: center;	border: none;	width: 50px;}</style><div class="printHealthFile">	<table class="table_personalInfor" cellpadding="0" cellspacing="0"		style="width: 19cm; border-collapse: collapse;">		<thead>			<tr>				<td style="text-align: center; height: 30px;" colspan="6"><span					style="font-size: 20px; font-weight: bolder;">1～2岁儿童健康检查记录表</span></td>			</tr>			<tr>				<td colspan="2" style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">姓名：</span></td>				<td>{Name}</td>				<td style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">编号：</span></td>				<td colspan="2">{FileNo}</td>			</tr>		</thead>		<tbody>			<tr>				<td colspan="2" class="header">月龄</td>				<td>12月龄</td>				<td>18月龄</td>				<td>24月龄</td>				<td>30月龄</td>			</tr>			<tr>				<td colspan="2" class="header">随访日期</td>				<td>{VisitDate1}</td>				<td>{VisitDate2}</td>				<td>{VisitDate3}</td>				<td>{VisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header">体重(kg)</td>				<td>{Weight1},{WeightScore1}</td>				<td>{Weight2},{WeightScore2}</td>				<td>{Weight3},{WeightScore3}</td>				<td>{Weight4},{WeightScore4}</td>			</tr>			<tr>				<td colspan="2" class="header">身长(cm)</td>				<td>{Height1},{HeightScore1}</td>				<td>{Height2},{HeightScore2}</td>				<td>{Height3},{HeightScore3}</td>				<td>{Height4},{HeightScore4}</td>			</tr>			<tr>			<tr>				<td rowspan="13">体格检查</td>				<td class="header">面色</td>				<td>{Face1},{FaceOther1}</td>				<td>{Face2},{FaceOther2}</td>				<td>{Face3},{FaceOther3}</td>				<td>{Face4},{FaceOther4}</td>			</tr>			<tr>				<td class="header">皮肤</td>				<td>{Exam011},{Exam01Other1}</td>				<td>{Exam012},{Exam01Other2}</td>				<td>{Exam013},{Exam01Other3}</td>				<td>{Exam014},{Exam01Other4}</td>			</tr>			<tr>				<td class="header">前卤</td>				<td>{Exam021},{Exam031}cm x {Exam041}cm</td>				<td>{Exam022},{Exam032}cm x {Exam042}cm</td>				<td>{Exam023},{Exam033}cm x {Exam043}cm</td>				<td>{Exam024},{Exam034}cm x {Exam044}cm</td>			</tr>			<tr>				<td class="header">眼外观</td>				<td>{Eyes1},{EyesOther1}</td>				<td>{Eyes2},{EyesOther2}</td>				<td>{Eyes3},{EyesOther3}</td>				<td>{Eyes4},{EyesOther4}</td>			</tr>			<tr>				<td class="header">耳外观</td>				<td>{Ears1},{EarsOther1}</td>				<td>{Ears2},{EarsOther2}</td>				<td>{Ears3},{EarsOther3}</td>				<td>{Ears4},{EarsOther4}</td>			</tr>			<tr>				<td class="header">听力</td>				<td>{Exam141}</td>				<td>—————</td>				<td>{Exam143}</td>				<td>—————</td>			</tr>			<tr>				<td class="header">出牙/龋齿数（颗）</td>				<td>{Exam051}/{Exam171}</td>				<td>{Exam052}/{Exam172}</td>				<td>{Exam053}/{Exam173}</td>				<td>{Exam054}/{Exam174}</td>			</tr>			<tr>				<td class="header">心肺</td>				<td>{Heart1},{HeartOther1}</td>				<td>{Heart2},{HeartOther2}</td>				<td>{Heart3},{HeartOther3}</td>				<td>{Heart4},{HeartOther4}</td>			</tr>			<tr>				<td class="header">腹部</td>				<td>{Exam061},{Exam06Other1}</td>				<td>{Exam062},{Exam06Other2}</td>				<td>{Exam063},{Exam06Other3}</td>				<td>{Exam064},{Exam06Other4}</td>			</tr>			<tr>				<td class="header">四肢</td>				<td>{Exam161},{Exam16Other1}</td>				<td>{Exam162},{Exam16Other2}</td>				<td>{Exam163},{Exam16Other3}</td>				<td>{Exam164},{Exam16Other4}</td>			</tr>			<tr>				<td class="header">步态</td>				<td>{Walk1},{WalkOther1}</td>				<td>{Walk2},{WalkOther2}</td>				<td>{Walk3},{WalkOther3}</td>				<td>{Walk4},{WalkOther4}</td>			</tr>			<tr>				<td class="header">可疑佝偻病体征</td>				<td>{ChildrenMediExamExam101}</td>				<td>{ChildrenMediExamExam102}</td>				<td>{ChildrenMediExamExam103}</td>				<td>{ChildrenMediExamExam104}</td>			</tr>			<tr>				<td class="header">血红蛋白值(g/L)</td>				<td>—————</td>				<td>{Exam122}g/L</td>				<td>—————</td>				<td>{Exam124}g/L</td>			</tr>			<tr>				<td colspan="2" class="header">户外活动</td>				<td>{ActivityTime1}小时/日</td>				<td>{ActivityTime2}小时/日</td>				<td>{ActivityTime3}小时/日</td>				<td>{ActivityTime4}小时/日</td>			</tr>			<tr>				<td colspan="2" class="header">服用维生素D</td>				<td>{WDCount1}IU/日</td>				<td>{WDCount2}IU/日</td>				<td>{WDCount3}IU/日</td>				<td>{WDCount4}IU/日</td>			</tr>			<tr>				<td colspan="2" class="header">发育评估</td>				<td>{Evaluate1},{EvaluateOther1}</td>				<td>{Evaluate2},{EvaluateOther2}</td>				<td>{Evaluate3},{EvaluateOther3}</td>				<td>{Evaluate4},{EvaluateOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">两次访问间患病情况</td>				<td>{State1}</td>				<td>{State2}</td>				<td>{State3}</td>				<td>{State4}</td>			</tr>			<tr>				<td colspan="2" class="header">其它</td>				<td>{Other1}</td>				<td>{Other2}</td>				<td>{Other3}</td>				<td>{Other4}</td>			</tr>			<tr>				<td colspan="2" class="header">转诊建议</td>				<td>{Transfer1}<br />原因：{TransReason1}<br />机构及科室：{TransUnit1}				</td>				<td>{Transfer2}<br />原因：{TransReason2}<br />机构及科室：{TransUnit2}				</td>				<td>{Transfer3}<br />原因：{TransReason3}<br />机构及科室：{TransUnit3}				</td>				<td>{Transfer4}<br />原因：{TransReason4}<br />机构及科室：{TransUnit4}				</td>			</tr>			<tr>				<td colspan="2" class="header">指导</td>				<td>{CheckDirect1},{CheckDirectOther1}</td>				<td>{CheckDirect2},{CheckDirectOther2}</td>				<td>{CheckDirect3},{CheckDirectOther3}</td>				<td>{CheckDirect4},{CheckDirectOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">下次随访日期</td>				<td>{NextVisitDate1}</td>				<td>{NextVisitDate2}</td>				<td>{NextVisitDate3}</td>				<td>{NextVisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header"					style="border-bottom: 1px solid #000;">随访医生签名</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor1}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor2}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor3}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor4}</td>			</tr>		</tbody>	</table></div>';
				var keys = {};
				$.each(data,function(i,v){
					var VulumeType = v.VulumeType;
					$.each(v,function(key,val){
				...
				console.log(printHtml);
				printObj.printHTML(printHtml,'1～2岁儿童健康检查记录表','12.99cm','30.8cm');
			}else if(optype == '3'){
				var printHtml = '<style type="text/css">.listInputValues {	margin-left: 10px;}.inputValues {	border: 1px solid #000;	width: 16px;	height: 16px;	text-align: center;}.printHealthFile,.table_personalInfor {	font-size: 14px;}.td_printHealthFile_content {	border-left: 1px solid #000000;	border-right: 1px solid #000000;	padding-left: 160px;	height: 60px;}.healthfileBasicInfo td {	height: 60px;	vertical-align: bottom;}.rightTableTd {	border-bottom: 1px solid #000000;}.table_personalInfor tbody td {	border-left: 1px solid #000;	border-right: 1px solid #000;	border-top: 1px solid #000;	height: 30px;	padding-left: 5px;}.childTable thead td {	border: none;}.childTable tbody td {	border: none;}.otherOption {	border-left: none;	border-right: none;	border-top: none;	border-bottom: 1px solid #000;	width: 80px;}.noneBorder {	text-align: center;	border: none;	width: 50px;}</style><div class="printHealthFile">	<table class="table_personalInfor" cellpadding="0" cellspacing="0"		style="width: 19cm; border-collapse: collapse;">		<thead>			<tr>				<td style="text-align: center; height: 30px;" colspan="6"><span					style="font-size: 20px; font-weight: bolder;">3～6岁儿童健康检查记录表</span></td>			</tr>			<tr>				<td colspan="2" style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">姓名：</span></td>				<td>{Name}</td>				<td style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">编号：</span></td>				<td colspan="2">{FileNo}</td>			</tr>		</thead>		<tbody>			<tr>				<td colspan="2" class="header">月龄</td>				<td>3岁</td>				<td>4岁</td>				<td>5岁</td>				<td>6岁</td>			</tr>			<tr>				<td colspan="2" class="header">随访日期</td>				<td>{VisitDate1}</td>				<td>{VisitDate2}</td>				<td>{VisitDate3}</td>				<td>{VisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header">体重(kg)</td>				<td>{Weight1},{WeightScore1}</td>				<td>{Weight2},{WeightScore2}</td>				<td>{Weight3},{WeightScore3}</td>				<td>{Weight4},{WeightScore4}</td>			</tr>			<tr>				<td colspan="2" class="header">身长(cm)</td>				<td>{Height1},{HeightScore1}</td>				<td>{Height2},{HeightScore2}</td>				<td>{Height3},{HeightScore3}</td>				<td>{Height4},{HeightScore4}</td>			</tr>			<tr>				<td colspan="2" class="header">体格发育评价</td>				<td>{Body1}</td>				<td>{Body2}</td>				<td>{Body3}</td>				<td>{Body4}</td>			</tr>			<tr>				<td rowspan="7">体格检查</td>				<td class="header">视力</td>				<td>—————</td>				<td>{Sight2}</td>				<td>{Sight3}</td>				<td>{Sight4}</td>			</tr>			<tr>				<td class="header">听力</td>				<td>{Hearing1}</td>				<td>—————</td>				<td>—————</td>				<td>—————</td>			</tr>						<tr>				<td class="header">出牙/龋齿数（颗）</td>				<td>{Tooth1}/{Caries1}</td>				<td>{Tooth2}/{Caries2}</td>				<td>{Tooth3}/{Caries3}</td>				<td>{Tooth4}/{Caries4}</td>			</tr>			<tr>				<td class="header">心肺</td>				<td>{Heart1},{HeartOther1}</td>				<td>{Heart2},{HeartOther2}</td>				<td>{Heart3},{HeartOther3}</td>				<td>{Heart4},{HeartOther4}</td>			</tr>			<tr>				<td class="header">腹部</td>				<td>{Venter1},{VenterOther1}</td>				<td>{Venter2},{VenterOther2}</td>				<td>{Venter3},{VenterOther3}</td>				<td>{Venter4},{VenterOther4}</td>			</tr>			<tr>				<td class="header">血红蛋白值(g/L)</td>				<td>{Hemoglobin1}g/L</td>				<td>{Hemoglobin2}g/L</td>				<td>{Hemoglobin3}g/L</td>				<td>{Hemoglobin4}g/L</td>			</tr>			<tr>				<td class="header">其它</td>				<td>{Other1}</td>				<td>{Other2}</td>				<td>{Other3}</td>				<td>{Other4}</td>			</tr>			<tr>				<td colspan="2" class="header">两次随访间患病情况</td>				<td>{CheckSickness1}<br/>肺炎：{Pneumonia1}次<br/>腹泻：{Scour1}次<br/>外伤：{Wound1}次<br/>其他{CheckSicknessOther1}</td>				<td>{CheckSickness2}<br/>肺炎：{Pneumonia2}次<br/>腹泻：{Scour2}次<br/>外伤：{Wound2}次<br/>其他{CheckSicknessOther2}</td>				<td>{CheckSickness3}<br/>肺炎：{Pneumonia3}次<br/>腹泻：{Scour3}次<br/>外伤：{Wound3}次<br/>其他{CheckSicknessOther3}</td>				<td>{CheckSickness4}<br/>肺炎：{Pneumonia4}次<br/>腹泻：{Scour4}次<br/>外伤：{Wound4}次<br/>其他{CheckSicknessOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">转诊建议</td>				<td>{Transfer1}<br />原因：{TransReason1}<br />机构及科室：{TransUnit1}				</td>				<td>{Transfer2}<br />原因：{TransReason2}<br />机构及科室：{TransUnit2}				</td>				<td>{Transfer3}<br />原因：{TransReason3}<br />机构及科室：{TransUnit3}				</td>				<td>{Transfer4}<br />原因：{TransReason4}<br />机构及科室：{TransUnit4}				</td>			</tr>			<tr>				<td colspan="2" class="header">指导</td>				<td>{CheckDirect1},{CheckDirectOther1}</td>				<td>{CheckDirect2},{CheckDirectOther2}</td>				<td>{CheckDirect3},{CheckDirectOther3}</td>				<td>{CheckDirect4},{CheckDirectOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">下次随访日期</td>				<td>{NextVisitDate1}</td>				<td>{NextVisitDate2}</td>				<td>{NextVisitDate3}</td>				<td>{NextVisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header"					style="border-bottom: 1px solid #000;">随访医生签名</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor1}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor2}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor3}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor4}</td>			</tr>		</tbody>	</table></div>';
				var keys = {};
				$.each(data,function(i,v){
					var VulumeType = v.VulumeType;
					$.each(v,function(key,val){
				...
				console.log(printHtml);
				printObj.printHTML(printHtml,'3～6岁儿童健康检查记录表','12.99cm','30.8cm');
			}else if(optype == '4'){
				var printHtml = '<style type="text/css">.listInputValues {	margin-left: 10px;}.inputValues {	border: 1px solid #000;	width: 16px;	height: 16px;	text-align: center;}.printHealthFile,.table_personalInfor {	font-size: 14px;}.td_printHealthFile_content {	border-left: 1px solid #000000;	border-right: 1px solid #000000;	padding-left: 160px;	height: 60px;}.healthfileBasicInfo td {	height: 60px;	vertical-align: bottom;}.rightTableTd {	border-bottom: 1px solid #000000;}.table_personalInfor tbody td {	border-left: 1px solid #000;	border-right: 1px solid #000;	border-top: 1px solid #000;	height: 30px;	padding-left: 5px;}.childTable thead td {	border: none;}.childTable tbody td {	border: none;}.otherOption {	border-left: none;	border-right: none;	border-top: none;	border-bottom: 1px solid #000;	width: 80px;}.noneBorder {	text-align: center;	border: none;	width: 50px;}</style><div class="printHealthFile">	<table class="table_personalInfor" cellpadding="0" cellspacing="0"		style="width: 19cm; border-collapse: collapse;">		<thead>			<tr>				<td style="text-align: center; height: 30px;" colspan="6"><span					style="font-size: 20px; font-weight: bolder;">第2～5次产前随访服务记录表</span></td>			</tr>			<tr>				<td colspan="2" style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">姓名：</span></td>				<td>{Name}</td>				<td style="text-align: right;"><span					style="font-size: 16px; font-weight: bolder;">编号：</span></td>				<td colspan="2">{FileNo}</td>			</tr>		</thead>		<tbody>			<tr>				<td colspan="2" class="header">项目</td>				<td>第2次</td>				<td>第3次</td>				<td>第4次</td>				<td>第5次</td>			</tr>			<tr>				<td colspan="2" class="header">随访日期</td>				<td>{VisitDate1}</td>				<td>{VisitDate2}</td>				<td>{VisitDate3}</td>				<td>{VisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header">孕周(周)</td>				<td>{Weeks1}</td>				<td>{Weeks2}</td>				<td>{Weeks3}</td>				<td>{Weeks4}</td>			</tr>			<tr>				<td colspan="2" class="header">主诉</td>				<td>{CC1}</td>				<td>{CC2}</td>				<td>{CC3}</td>				<td>{CC4}</td>			</tr>			<tr>				<td colspan="2" class="header">体重（kg）</td>				<td>{Weight1}</td>				<td>{Weight2}</td>				<td>{Weight3}</td>				<td>{Weight4}</td>			</tr>			<tr>				<td rowspan="4">产科检查</td>				<td class="header">宫底高度（cm）</td>				<td>{Exam011}</td>				<td>{Exam012}</td>				<td>{Exam013}</td>				<td>{Exam014}</td>			</tr>			<tr>				<td class="header">腹围（cm）</td>				<td>{Exam021}</td>				<td>{Exam022}</td>				<td>{Exam023}</td>				<td>{Exam024}</td>			</tr>			<tr>				<td class="header">胎位</td>				<td>{Exam071}</td>				<td>{Exam072}</td>				<td>{Exam073}</td>				<td>{Exam074}</td>			</tr>			<tr>				<td class="header">胎心率（次/分钟）</td>				<td>{Exam031}</td>				<td>{Exam032}</td>				<td>{Exam033}</td>				<td>{Exam034}</td>			</tr>			<tr>				<td colspan="2" class="header">血压（mmHg）</td>				<td>{DiastolicPressure1}/{SystolicPressure1}</td>				<td>{DiastolicPressure2}/{SystolicPressure2}</td>				<td>{DiastolicPressure3}/{SystolicPressure3}</td>				<td>{DiastolicPressure4}/{SystolicPressure4}</td>			</tr>			<tr>				<td colspan="2" class="header">血红蛋白值(g/L)</td>				<td>{Exam041}g/L</td>				<td>{Exam042}g/L</td>				<td>{Exam043}g/L</td>				<td>{Exam044}g/L</td>			</tr>			<tr>				<td colspan="2" class="header">尿蛋白</td>				<td>{Exam051}</td>				<td>{Exam052}</td>				<td>{Exam053}</td>				<td>{Exam054}</td>			</tr>			<tr>				<td colspan="2" class="header">其他辅助检查</td>				<td>{Exam061}</td>				<td>{Exam062}</td>				<td>{Exam063}</td>				<td>{Exam064}</td>			</tr>			<tr>				<td colspan="2" class="header">分类</td>				<td>{Result1},{ResultOther1}</td>				<td>{Result2},{ResultOther2}</td>				<td>{Result3},{ResultOther3}</td>				<td>{Result4},{ResultOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">指导</td>				<td>{BeforeBornDirect1},{BeforeBornDirectOther1}</td>				<td>{BeforeBornDirect2},{BeforeBornDirectOther2}</td>				<td>{BeforeBornDirect3},{BeforeBornDirectOther3}</td>				<td>{BeforeBornDirect4},{BeforeBornDirectOther4}</td>			</tr>			<tr>				<td colspan="2" class="header">转诊建议</td>				<td>{Transfer1}<br />原因：{TransReason1}<br />机构及科室：{TransUnit1}				</td>				<td>{Transfer2}<br />原因：{TransReason2}<br />机构及科室：{TransUnit2}				</td>				<td>{Transfer3}<br />原因：{TransReason3}<br />机构及科室：{TransUnit3}				</td>				<td>{Transfer4}<br />原因：{TransReason4}<br />机构及科室：{TransUnit4}				</td>			</tr>			<tr>				<td colspan="2" class="header">下次随访日期</td>				<td>{NextVisitDate1}</td>				<td>{NextVisitDate2}</td>				<td>{NextVisitDate3}</td>				<td>{NextVisitDate4}</td>			</tr>			<tr>				<td colspan="2" class="header"					style="border-bottom: 1px solid #000;">随访医生签名</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor1}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor2}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor3}</td>				<td style="border-bottom: 1px solid #000;">{VisitDoctor4}</td>			</tr>		</tbody>	</table></div>';
				var keys = {};
				$.each(data,function(i,v){
					var VulumeType = v.VulumeType;
					$.each(v,function(key,val){
						...
						if(key != 'VulumeType'){
							if(key == 'FileNo' || key == 'Name'){
								...
								var keyName = key + VulumeType;							
								if((key == 'VisitDate' || key == 'NextVisitDate') && val != null){
									val = val.getFullYear() + '年' + PrintHealthFileAndExamClass.addZero(val.getMonth()) + '月' + 
										PrintHealthFileAndExamClass.addZero(val.getDate()) + '日';
								}
								if(key == 'Transfer'){
				...
				console.log(printHtml);
				printObj.printHTML(printHtml,'第2～5次产前随访服务记录表','12.99cm','30.8cm');
			}
		}else{
			showInfoObj.Infor('无相应体检记录');
		}
	});
}
