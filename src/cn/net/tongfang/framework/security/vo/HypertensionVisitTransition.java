...
/**
 * HypertensionVisitTransition entity. @author MyEclipse Persistence Tools
 */

public class HypertensionVisitTransition implements java.io.Serializable {
	...
	/** default constructor */
	public HypertensionVisitTransition() {
	}

	/** minimal constructor */
	public HypertensionVisitTransition(String id, String fileNo,
			String inputPersonId, Timestamp inputDate, Timestamp visitDate) {
		this.id = id;
		this.fileNo = fileNo;
	...
	public HypertensionVisitTransition(String id, String fileNo,
			String inputPersonId, Timestamp inputDate, Timestamp visitDate,
			String visitKind, String symptomOther, String compliance,
			String adr, String adrother, String visitType, Boolean transfer,
			String transReason, String transUnit, Timestamp nextVistDate,
			String visitDoctor, Double diastolicPressure,
			Double systolicPressure, Double weight, Double habitus,
			...
			String execDistrictNum, String scellId, String serialno,
			String checkFlag) {
		this.id = id;
		this.fileNo = fileNo;
		this.inputPersonId = inputPersonId;
